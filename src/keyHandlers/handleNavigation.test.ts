...
import type { BooleanField, InquirerReadline, InternalFields, RadioField, TextField } from 'src/util/types.js'
...
describe('handleNavigation', () => {
    ...
    describe('down key navigation', () => {
        ...
        it('should skip separators when moving down', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(2) // Skip separator at index 1
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
        ...
        it('should handle multiple consecutive separators', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(3) // Skip both separators
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
        ...
        it('should wrap to beginning when all remaining fields are separators', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(0) // Wrap to start since only separators remain
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
    })
    ...
    describe('up key navigation', () => {
        ...
        it('should skip separators when moving up', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(1) // Skip separator at index 2
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
        ...
        it('should handle multiple consecutive separators when moving up', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(0) // Skip both separators
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
        ...
        it('should wrap to last non-separator from first when previous fields are separators', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(3) // Wrap to last non-separator
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
    })
    ...
    describe('boundary conditions', () => {
        it('should handle negative focusedIndex for down navigation', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(0) // nextNonSeparatorIndex from -1
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
    ...
    describe('complex separator scenarios', () => {
        ...
        it('should handle separator in middle with up navigation', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(0) // Skip separator at index 1
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
        ...
        it('should handle wrapping with separators at end', () => {
            ...
            expect(result).toBe(true)
            expect(mockSetFocusedIndex).toHaveBeenCalledWith(0) // Wrap to beginning
            expect(mockRl.clearLine).toHaveBeenCalledWith(0)
        })
    ...
    describe('setFocusedIndex call patterns', () => {
        it('should only call setfocusedIndex once per navigation', () => {
            ...
            expect(mockSetFocusedIndex).toHaveBeenCalledTimes(1)
        })
